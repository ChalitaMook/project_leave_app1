                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                      ...
                      <div class="col">
                        <div class="card shadow-sm">
                          ...
                          <div class="card-body">
                            <div class="d-grid gap-2 font1">
                                <a href="{{ url('/hr/business_form') }}" class="stretched-link btn btn-primary btn-lg" >ลากิจ</a>                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col">
                        <div class="card shadow-sm">
                          ...
                          <div class="card-body">
                            <div class="d-grid gap-2 font1">
                                <a href="{{ url('/hr/sick_form') }}" class="stretched-link btn btn-primary btn-lg">ลาป่วย</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col">
                        <div class="card shadow-sm">
                          ...
                          <div class="card-body">
                                <div class="d-grid gap-2 font1">
                                    <a href="{{ url('/hr/annual_form') }}" class="stretched-link btn btn-primary btn-lg">ลาพักร้อน</a>
                                </div>
                            </div>
                          </div>
                        </div>
