...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet">
                ...
                <ul class="sidebar-nav font1">
                    ...
                    <li>
                        <a href="{{ url('/hr/profile') }}">โปรไฟล์</a>
                    </li>
                    <li>
                        <a href="{{ url('/hr/officer_table') }}">ข้อมูลพนักงาน</a>
                    </li>
                    <li>
                        <a href="{{ url('/hr/leave_main') }}">แจ้งวันลา</a>
                    </li>
                    <li>
                        <a href="{{ url('/hr/leave_table') }}">ดูรายการวันลา</a>
                    </li>
                    <li>
                        <a href="{{ url('/hr/my_leave_table') }}">ดูรายการวันลาของตัวเอง</a>
                    </li>
                </ul>
                </div>
...
<div class="container bootstrap snippets bootdey">
    <div class="row">
        <div class="col-lg-12 font1">
            <a href="{{ url('/hr/my_leave_table/approve') }}" class="btn btn-success">ดูรายการที่อนุมัติ</a>
            <a href="{{ url('/hr/my_leave_table/disapprove') }}" class="btn btn-secondary">ดูรายการที่ไม่อนุมัติ</a>
                        ...
                        <table class="table user-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($item1->leader_status=='0')
                                                    <td>รอการอนุมัติ</td>
                                    @endif
                                    <td style="width: 30%;">

                                        <a href="{{url('/hr/annual_form_edit/'.$item1->id)}}" class="table-link text-info">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
                                    ...
                                    <td>
                                        <a href="{{url('/hr/annual_form/delete/'.$item1->id)}}" class="table-link danger">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if ($item2->leader_status=='0')
                                                        <td>รอการอนุมัติ</td>
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/hr/sick_form_edit/'.$item2->id)}}" class="table-link text-info">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
                                        ...
                                        <td>
                                            <a href="{{url('/hr/sick_form/delete/'.$item2->id)}}" class="table-link danger">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
                                                </span>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if ($item3->leader_status=='0')
                                                        <td>รอการอนุมัติ</td>
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/hr/business_form_edit/'.$item3->id)}}" class="table-link text-info">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
                                        ...
                                        <td>
                                            <a href="{{url('/hr/business_form/delete/'.$item3->id)}}" class="table-link danger">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
                                                </span>
