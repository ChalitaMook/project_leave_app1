...
<div class="container" >
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <br>
            <a href="{{ url('/hr/leave_main') }}" class="btn btn-secondary">Back</a>
...
<div class="card h-200">
    <div class="card-body">
        ...
        @else
            ...
            @endif
        <form action="{{url('/hr/business_form/store')}}" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="row gutters">
        ...
        <input type="hidden" id="leader_status" name="leader_status" value="0" > {{-- ความเห็นหัวหน้า --}}
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    <label for="title">หัวข้อ:</label><br>
                    <input type="text" id="title" name="title" value="{{old('title')}}" class="form-control"><br>
                </div>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
                    <label for="phone_num">เบอร์โทร:</label><br>
                    <input type="text" id="phone_num" maxlength="10" name="phone_num" class="form-control" value="{{Auth::user()->phone_num}}"><br>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
