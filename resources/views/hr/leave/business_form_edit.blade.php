...
<h1 class="mb-2 text-primary">ฟอร์มแจ้งวันลากิจ</h1>
<br>
<a href="{{ url('/hr/my_leave_table')}}" class="btn btn-secondary">กลับ</a>

</div>
<div class="card h-200">
<div class="card-body">
@if (Auth::user()->business_leave =='0')
                    ...
                    <div class="row gutters">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" aria-label="contract_person" id="contract_person" name="contract_person">
                                            <option selected>-</option>
                                            @if (Input::old('contract_person') == $key)
                                                    <option value="{{ $key }}" selected>{{ $val }}</option>
                                                @else
                                                    <option value="{{ $key }}">{{ $val }}</option>
                                                @endif
                                            @foreach ($items2 as $item2)
                                                <option value="{{$item2->name}} {{$item2->lastname}}">{{$item2->name}} {{$item2->lastname}}</option>
                                            @endforeach
                                        </select>
                                        <br>
                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" value="{{ $items1->start_date->format('m/d/Y') }}" class="form-control" />
                                <script>
                                $(function() {
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="end_date" value="{{ $items1->end_date->format('m/d/Y') }}" class="form-control" />
                                <script>
                                    $(function() {
...
วันลาคงเหลือ {{Auth::user()->business_leave}} วัน
</div>
@if ($errors->any())
...
@endif
<form action="{{url('/hr/business_form_edit/update/'.$items1->id)}}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row gutters">
<input type="hidden" id="user_id" name="user_id" value="{{Auth::user()->id}}" >
<input type="hidden" id="department" name="department" value="{{Auth::user()->department}}" >
<input type="hidden" id="type_id" name="type_id" value="3" >{{-- ประเภทลา --}}
<input type="hidden" id="leader_status" name="leader_status" value="0" > {{-- ความเห็นหัวหน้า --}}
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="form-group">
            <label for="title">หัวข้อ:</label><br>
            <input type="text" id="title" name="title" class="form-control" value="{{$items1->title}}"><br>
        </div>
    </div>
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="form-group">
            <label for="detail">รายละเอียด:</label><br>
            <textarea name="detail" id="detail" cols="30" rows="3" class="form-control" >{{$items1->detail}}</textarea>
            <br>
        </div>
    </div>
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="form-group">
            <label for="phone_num">เบอร์โทร:</label><br>
            <input type="text" id="phone_num" maxlength="10" name="phone_num" class="form-control" value="{{$items1->phone_num}}"><br>
        </div>
    </div>
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="form-group">
