            ...
            <div class="container" >
                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h1 class="mb-2 text-primary">ฟอร์มแจ้งวันลาพักร้อน</h1>
                        <br>
            ...
            <div class="card h-200">
                <div class="card-body">
                    ...
                    @else
                        ...
                        @endif
                    <form action="{{url('/hr/annual_form/store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if (session('error'))
                    <div class="alert alert-danger">
                        {{ session('error') }}
                ...
                <div class="row gutters">
                    ...
                    <input type="hidden" id="leader_status" name="leader_status" value="0" > {{-- ความเห็นหัวหน้า --}}
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                <label for="title">หัวข้อ:</label><br>
                                <input type="text" id="title" value="{{old('title')}}" name="title" class="form-control"><br>
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
