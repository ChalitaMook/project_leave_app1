...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    ...
    <div id="wrapper" class="wrapper-content">
        ...
        <div id="page-content-wrapper">
            ...
            <a href="{{ url('/hr/officer_form') }}" class="btn btn-primary">เพิ่มข้อมูลพนักงาน</a>
        </div>
            <div>
                        ...
                        <table class="table user-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%;">
                                        <a href="{{url('/hr/officer_form_edit/'.$item->id)}}" class="table-link text-info">
                                            <span class="fa-stack">
                                    ...
                                    <td>
                                        <a href="{{url('/hr/officer_form/delete/'.$item->id)}}" class="table-link danger">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
