                        ...
                        <table class="table user-list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td style="width: 30%;">
                                        <a href="{{url('/lead/annual_status_form/'.$item1->id)}}" class="table-link">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x" style="color: #f644ff"></i>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/lead/sick_status_form/'.$item2->id)}}" class="table-link">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x" style="color: #f644ff"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/lead/business_status_form/'.$item3->id)}}" class="table-link">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x" style="color: #f644ff"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
