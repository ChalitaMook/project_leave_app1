...
<br>
<a href="{{ url('/lead/my_leave_table')}}" class="btn btn-secondary">กลับ</a>
...
@endif
<form action="{{url('/lead/business_form_edit/update/'.$items1->id)}}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row gutters">
