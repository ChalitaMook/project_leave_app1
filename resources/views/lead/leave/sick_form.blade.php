...
<div class="card-body">
    ...
    @else
        ...
        @endif
            <form action="{{url('/lead/sick_form/store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row gutters">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
                    <label for="phone_num">เบอร์โทร:</label><br>
                    <input type="text" id="phone_num" name="phone_num" maxlength="10" class="form-control" value="{{Auth::user()->phone_num}}"><br>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group">
