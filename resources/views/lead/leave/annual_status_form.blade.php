...
<div class="container" >
    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h1 class="mb-2 text-primary">แจ้งวันลาพักร้อน</h1>
            <br>
            <a href="{{ url('/lead/leave_table') }}" class="btn btn-secondary">กลับ</a>

        </div>
<div class="card h-200">
    <div class="card-body">
        <form action="{{url('/lead/annual_status_update/'.$items1->id.$items1->user_id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @if (session('error'))
