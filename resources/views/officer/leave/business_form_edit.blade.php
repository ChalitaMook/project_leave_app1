...
<br>
<a href="{{ url('/officer/my_leave_table')}}" class="btn btn-secondary">กลับ</a>
...
@endif
    <form action="{{url('/officer/business_form_edit/update/'.$items1->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row gutters">
        ...
        <input type="hidden" id="type_id" name="type_id" value="3" >{{-- ประเภทลา --}}
            <input type="hidden" id="leader_status" name="leader_status" value="0" > {{-- ความเห็นหัวหน้า --}}
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label for="phone_num">เบอร์โทร:</label><br>
                        <input type="text" maxlength="10" id="phone_num" name="phone_num" class="form-control" value="{{$items1->phone_num}}"><br>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
