                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" vvalue="{{old('end_date')}}" class="form-control" />
                                <script>
                                $(function() {
...
@endif
    <form action="{{url('/officer/business_form/store')}}" method="POST" enctype="multipart/form-data">
    @csrf
        <div class="row gutters">
