...
<div class="container bootstrap snippets bootdey">
    <div class="row">
        <div class="col-lg-12 font1">
            <a href="{{ url('/officer/my_leave_table/approve')}}" class="btn btn-success">ดูรายการที่อนุมัติ</a>
            <a href="{{ url('/officer/my_leave_table/disapprove')}}" class="btn btn-secondary">ดูรายการที่ไม่อนุมัติ</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%;">
                                        ...
                                        <a href="{{url('/officer/annual_form_edit/'.$item1->id)}}" class="table-link text-info">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
                                    ...
                                    <td>
                                        <a href="{{url('/officer/annual_form/delete/'.$item1->id)}}" class="table-link danger">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/officer/sick_form_edit/'.$item2->id)}}" class="table-link text-info">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
                                        ...
                                        <td>
                                            <a href="{{url('/officer/sick_form/delete/'.$item2->id)}}" class="table-link danger">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
                                                </span>
                            ...
                            <table class="table user-list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td style="width: 30%;">
                                            <a href="{{url('/officer/business_form_edit/'.$item3->id)}}" class="table-link text-info">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                </span>
                                        ...
                                        <td>
                                            <a href="{{url('/officer/business_form/delete/'.$item3->id)}}" class="table-link danger">
                                                <span class="fa-stack">
                                                    <i class="fa fa-square fa-stack-2x"></i>
                                                    <i class="fa fa-trash-o fa-stack-1x fa-inverse"></i>
                                                </span>
